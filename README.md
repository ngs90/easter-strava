# Strava Activities Dashboard (autogenerated with GPT-4)
...
3. Configure your environment variables for Neo4j and Strava API access (refer to `src/config.py` for the required variables).
